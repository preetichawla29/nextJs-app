...
/* themes/custom/contribution_tracker/templates/node/node--contribution--full.html.twig */
class __TwigTemplate_f7549b450b12e4e702dbd5d469646907 extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (\Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 75, $this->source))) : ("")), 5 => "clearfix"];
  ...
  <div";
    ...
    <div class=\"field field--name-field-contribution-version field--type-list-string field--label-above\">
      <div class=\"field--label\">Contribution Author</div>
...
";
    ...
    {
        return "themes/custom/contribution_tracker/templates/node/node--contribution--full.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/contribution_tracker/templates/node/node--contribution--full.html.twig", "/var/www/html/docroot/themes/custom/contribution_tracker/templates/node/node--contribution--full.html.twig");
    }
