...
class __TwigTemplate_cfc104c3e409dec50e031a2cb256d20d extends Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 31, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button--split.html.twig", "/var/www/html/docroot/themes/contrib/bootstrap/templates/input/input--button--split.html.twig");
    }
